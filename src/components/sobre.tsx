      ...
      <div className="container px-4 mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="relative w-full h-[350px] rounded-3xl overflow-hidden bg-[#02452a]">
              <Image
                src="/logo-center.png"
                alt="logoCenter"
                fill
            ...
            <div className="absolute w-40 h-40 right-8 -bottom-8 rounded-lg border-4 border-white overflow-hidden bg-[#02452a]">
              <Image
                src="/logo-right.png"
                alt="logoRight"
                fill
